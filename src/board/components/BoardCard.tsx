 ...
 return (
  ...
  >
   <button className="block w-full text-left" onClick={() => onSelect(board.id)} type="button">
    ...
    <p className="mt-3 line-clamp-2 text-sm text-slate-600">{board.description || "沒有描述"}</p>
   </button>

   <div className="mt-4 flex gap-2">
    <button
     className="rounded-md border border-slate-300 px-3 py-1.5 text-sm font-medium text-slate-700 transition hover:bg-slate-100 hover:cursor-pointer"
    ...
    <button
     className="rounded-md border border-red-200 px-3 py-1.5 text-sm font-medium text-red-600 transition hover:bg-red-50 hover:cursor-pointer"

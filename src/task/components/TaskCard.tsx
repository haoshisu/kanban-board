 ...
 return (
  ...
  >
   ...
   <div className="mt-3 flex gap-2">
    <button
     className="rounded-md border border-slate-300 px-2.5 py-1 text-xs font-medium text-slate-700 transition hover:cursor-pointer hover:bg-slate-100"
     onClick={() => onEdit(task)}
     type="button"
    >
     修改
    ...
    <button
     className="rounded-md border border-red-200 px-2.5 py-1 text-xs font-medium text-red-600 transition hover:cursor-pointer hover:bg-red-50"
